...
def charRemover():
        ...
        toBeRemoved = input("Enter the character to be removed from the string: ")
...
def charInstance():
        ...
        if len(targetChar) == 1:
                ...
                print(f"\nNumber of instances of \"{targetChar}\" in {str} is {instance}")
        else:
...
def sortBySign():
        ...
        while True:
                try:
                        inputTaker = input("Enter a number (Type 'END' to end. Case sensitive): ")
...
def filterDupes():
        ...
        for i in str:
                if i in singleAppearence:
                        if i in multiAppearence:
                                pass
                        else:
